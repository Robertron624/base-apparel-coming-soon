...
- [Vite](https://vitejs.dev/guide/) - JS bundler

### What I learned

With this project I refreshed my sass skills and layout concepts

### Continued development

I'm going to start using another javascript framework for the next projects that require javascript, the next one is going to be Vue.js.
